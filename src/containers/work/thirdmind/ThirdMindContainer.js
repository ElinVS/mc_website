...
import '../thirdmind/ThirdMind.css'
import Header from '../../../components/header/Header'

const ThirdMindContainer = () => {
  ...
  return (
    ...
    <section className='third-mind-page'>
      <div className='third-mind-grid-wrapper'>

        <div className='third-mind-grid-one'>
        </div>
...
The project was premiered at the Centre for Contemporary Arts in Glasgow, March 5-6th 2013 in association with Cryptic Nights. It was supported by an Alt-W Production award from New Media Scotland.</p>
        ...
        <div className='third-mind-grid-six'>
        </div>
        <div className='third-mind-grid-seven'>
        </div>
